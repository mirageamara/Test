...
public class supprimeremployee extends AppCompatActivity {
    Button b;
    ...
    private static String url_create_product =ipconfig.ip+"/location/supprimeremployee.php";
    //JSON Node names
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supprimeremployee);
        b=findViewById(R.id.button3);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(supprimeremployee.this,loginemployee.class);
                startActivity(i);
            }
        });
    ...
    class CreateNewProduct extends AsyncTask <String,String,String>  {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(supprimeremployee.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String login = edt2.getText().toString();
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    alert=new AlertDialog.Builder(supprimeremployee.this);
